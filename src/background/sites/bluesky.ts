...
type BlueskyOptionsValues = SiteOptions<typeof bluesky_form>;

type BlueskyFileMeta = Pick<BlueskyFile, 'fileName' | 'ext'>;
type BlueskyFileData = FileData<BlueskyFileMeta>;
type BlueskySubmissionMeta = Omit<BlueskyFile, keyof BlueskyFileMeta>;
type BlueskySubmissionData = SubmissionData<BlueskySubmissionMeta>;
