...
const furaffinity_info: SiteInfo = {
    site: 'furaffinity',
    label: 'Fur Affinity',
    links: {
...
type FuraffinityOptionsValues = SiteOptions<typeof furaffinity_form>;

type FuraffinityFileMeta = Pick<FuraffinityFile, 'fileName' | 'fileId' | 'ext'>;
type FuraffinityFileData = FileData<FuraffinityFileMeta>;
type FuraffinitySubmissionMeta = Omit<FuraffinityFile, keyof FuraffinityFileMeta>;
type FuraffinitySubmissionData = SubmissionData<FuraffinitySubmissionMeta>;
