...
const pixiv_form = {
    ...
    multiple: {
        ...
        default:
            'Saved/{site}/{userName}_{userId}/{submissionId}_{title}/{submissionId}_{title}_{page}_by_{userName}.{ext}',
...
type PixivOptionsValues = SiteOptions<typeof pixiv_form>;

type PixivFileMeta = Pick<PixivFile, 'fileName' | 'ext'>;
type PixivFileData = FileData<PixivFileMeta>;
type PixivSubmissionMeta = Omit<PixivFile, keyof PixivFileMeta>;
type PixivSubmissionData = SubmissionData<PixivSubmissionMeta>;
